...
<body>
  <header>
    <div class="header-menu">
      ...
      <nav>
        <ul>
          ...
          <li><button class="login"><a href="p/signup.html">LOGIN</a></button></li>
        </ul>
      </nav>
    ...
    <script type="text/javascript">
      ...
      <button class="start"><a href="p/signup.html">Get Started</a></button><br><br>
  ...
  <footer>
    ...
    <section class="table">
      ...
      <button class="start"><a href="p/signup.html">Get Started</a></button><br><br><br>
